      ...
      <div class="row">
          ...
          <form action="insert.php" method="POST">
              ...
              <div class="mb-3">
                  ...
                  <input type="email" name="mail" placeholder="Enter User E-mail"class="form-control">
              </div>

              <div class="mb-3">
                  <label for="#">User Phone Number</label>
                  <input type="text"name="number"placeholder="Enter User Phone Number"class="form-control">
              </div>
              ...
              <div class="mb-3">
              <button class="w-100 bg-danger fs-4 fw-bold form-control text-white">Already have an Account</button>
              </div>
